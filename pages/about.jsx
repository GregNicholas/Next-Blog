...
export default function aboutPage() {
	const aboutText = `Welcome to a whole new world of opportunity! Join us as we explore the 											amazing world of computer science. Whether you're just getting started in
		...
		<>
		  <main>
			...
			<section className={styles.aboutContent}>
				...
				<p className={styles.aboutContentText}>{aboutText}</p>
			</section>
			<Link href='/'>
